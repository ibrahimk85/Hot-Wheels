/**
 * Script to download image assets for 2018 Hot Wheels Silver Series - Black and Gold 50th Anniversary.
 *
 * How to use:
 *   npx ts-node scripts/tools/download_and_sync_images_2018_silver_series_black_and_gold.ts
 */
...
const BASE_SUBDIR = 'silver-series/black-and-gold';
...
async function main() {
  console.log('=== BLACK AND GOLD 50TH ANNIVERSARY (2018) IMAGE DOWNLOAD SCRIPT ===');
