/**
 * Script to download images for 2026 Pearl&Chrome Anniversary Series (Blue and Gold Series).
 *
 * How to use:
 *   npx ts-node scripts/tools/download_pearl_chrome_anniversary_2026.ts
 */
