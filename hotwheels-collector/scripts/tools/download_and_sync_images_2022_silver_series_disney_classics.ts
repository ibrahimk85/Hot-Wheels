...
const WIKI_URL = 'https://hotwheels.fandom.com/wiki/Disney_Classics_Series_(2022)';
const COLLECTION_NAME = 'Hot Wheels Silver Series';
const SERIES_NAME = 'Disney Classics (2022)';
const BASE_SUBDIR = 'silver-series/disney-classics';
...
async function main() {
  console.log('=== Disney Classics (2022) IMAGE SCRIPT ===');
