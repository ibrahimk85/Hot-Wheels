/**
 * Download images for 2020 HW Police (Automotive) - 10-col: Col # | Toy # | Casting | Color | Tampos | Wheel Type | Notes | Photo Loose | Photo Carded Missing Logo | Photo Carded Returned Logo
 * npx ts-node scripts/tools/download_and_sync_images_2020_silver_series_hw_police.ts
 */
...
const WIKI_URL = 'https://hotwheels.fandom.com/wiki/HW_Police_Series_(2020)';
const COLLECTION_NAME = 'Hot Wheels Silver Series';
const SERIES_NAME = 'HW Police (2020)';
const BASE_SUBDIR = 'silver-series/hw-police';
...
async function main() {
  console.log('=== HW POLICE (2020) IMAGE SCRIPT ===');
