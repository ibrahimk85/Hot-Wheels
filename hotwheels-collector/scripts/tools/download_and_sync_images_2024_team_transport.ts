/**
 * Script to download image assets for the 2025 Hot Wheels Team Transport set and
 * associate them with Model and Variant records in your database.
 *
 * This script performs two jobs:
 *   1. Fetches the 2025 Team Transport page from the Hot Wheels Fandom wiki and
 ...
 *      `public/images/hotwheels/2025/team-transport/` folder.
 ...
 *     the 2025 Team Transport variants using the import script.
 ...
 *
 * Usage:
 *   npx ts-node scripts/tools/download_and_sync_images_2025_team_transport.ts
 */
...
const TEAM_TRANSPORT_URL = 'https://hotwheels.fandom.com/wiki/2025_Car_Culture:_Team_Transport';
