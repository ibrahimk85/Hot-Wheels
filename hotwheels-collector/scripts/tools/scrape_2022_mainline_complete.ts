/**
 * Comprehensive script to scrape 2022 Hot Wheels Mainline data from Fandom Wiki
 * 
 * This script:
 * 1. Fetches the main table from List_of_2022_Hot_Wheels
 ...
 * 
 * Usage:
 *   npx ts-node scripts/tools/scrape_2022_mainline_complete.ts
 */
...
// Main function
async function main() {
  console.log('🚀 Starting 2022 Mainline Complete Scraper\n');
  ...
  try {
    ...
    const baseImageDir = path.join(process.cwd(), 'public', 'images', 'hotwheels', '2022', 'mainline');
