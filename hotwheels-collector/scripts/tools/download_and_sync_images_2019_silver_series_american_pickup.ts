...
const WIKI_URL = 'https://hotwheels.fandom.com/wiki/American_Pickup_Series_(2019)';
const COLLECTION_NAME = 'Hot Wheels Silver Series';
const SERIES_NAME = 'American Pickup (2019)';
const BASE_SUBDIR = 'silver-series/american-pickup';
...
async function main() {
  console.log('=== AMERICAN PICKUP (2019) IMAGE SCRIPT ===');
