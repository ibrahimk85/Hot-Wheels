/**
 * Script to download image assets for the 2021 Hot Wheels Fast & Furious Series.
 * 
 * This script:
 *   1. Fetches the Fast & Furious Series page from the Hot Wheels Fandom wiki
 *   2. Extracts Photo Carded and Photo Loose image URLs for 2021 year table
 *   3. Downloads images to public/images/hotwheels/2021/fast-and-furious/{castingSlug}/
 ...
 * - Variant matching: Year + Col # + Casting Name + Color + SubSeries
 * 
 * 2021 Table Structure (9 columns):
 * - Column 0: Col # - e.g., "1/5"
 * - Column 1: Toy #
 ...
 * 
 * How to use:
 *   npx ts-node scripts/tools/download_and_sync_images_2021_fast_and_furious.ts
 */
