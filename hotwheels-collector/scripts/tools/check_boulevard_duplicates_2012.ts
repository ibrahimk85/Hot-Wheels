/**
 * Script to check for duplicate Boulevard models and variants in the database for 2012
 * 
 ...
 * 3. Models without subSeries (which should have themed Mix names)
 */
...
async function main() {
  console.log(`=== BOULEVARD ${targetYear} DUPLICATE CHECK ===\n`);
