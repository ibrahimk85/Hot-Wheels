...
const WIKI_URL = 'https://hotwheels.fandom.com/wiki/Gran_Turismo_Series_(2024)';
const COLLECTION_NAME = 'Hot Wheels Silver Series';
const SERIES_NAME = 'Gran Turismo (2024)';
const BASE_SUBDIR = 'silver-series/gran-turismo';
...
async function main() {
  console.log('=== GRAN TURISMO (2024) IMAGE SCRIPT ===');
