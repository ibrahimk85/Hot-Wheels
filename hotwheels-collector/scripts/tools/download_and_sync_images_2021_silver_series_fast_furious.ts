...
const WIKI_URL = 'https://hotwheels.fandom.com/wiki/Fast_%26_Furious_Series_(2021)';
const COLLECTION_NAME = 'Hot Wheels Silver Series';
const SERIES_NAME = 'Fast & Furious (2021)';
const BASE_SUBDIR = 'silver-series/fast-furious';
...
async function main() {
  console.log('=== Fast & Furious (2021) IMAGE SCRIPT ===');
