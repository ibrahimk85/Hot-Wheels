/**
 * Script to download image assets for the 2019 Hot Wheels Team Transport set and
 * associate them with Model and Variant records in your database.
 *
 * This script performs two jobs:
 *   1. Fetches the 2019 Team Transport page from the Hot Wheels Fandom wiki and
 ...
 *      `public/images/hotwheels/2019/team-transport/` folder.
 ...
 *     the 2019 Team Transport variants using the import script.
...
const TEAM_TRANSPORT_URL = 'https://hotwheels.fandom.com/wiki/2019_Car_Culture:_Team_Transport';
