/**
 * Script to download images for Blue and Gold Series variants.
 *
 * This script:
 *   1. Fetches Blue and Gold Series wiki page for the specified year(s)
...
// Table structure for Blue and Gold (9 columns):
...
function getImageTypesForYear(year: number) {
  // All years have the same structure for Blue and Gold
  return [
