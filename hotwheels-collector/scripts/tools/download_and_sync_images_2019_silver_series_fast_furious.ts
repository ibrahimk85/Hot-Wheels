...
const WIKI_URL = 'https://hotwheels.fandom.com/wiki/Fast_%26_Furious_Series_(2019)';
const COLLECTION_NAME = 'Hot Wheels Silver Series';
const SERIES_NAME = 'Fast & Furious (2019)';
const BASE_SUBDIR = 'silver-series/fast-furious-2019';
...
async function main() {
  console.log('=== Fast & Furious (2019) IMAGE SCRIPT ===');
