/**
 * Download images for 2022 Racing Circuit (Automotive) - 8-col
 * npx ts-node scripts/tools/download_and_sync_images_2022_silver_series_racing_circuit.ts
 */
...
const WIKI_URL = 'https://hotwheels.fandom.com/wiki/Racing_Circuit_Series_(2022)';
const COLLECTION_NAME = 'Hot Wheels Silver Series';
const SERIES_NAME = 'Racing Circuit (2022)';
const BASE_SUBDIR = 'silver-series/racing-circuit';
...
async function main() {
  console.log('=== Racing Circuit (2022) IMAGE SCRIPT ===');
