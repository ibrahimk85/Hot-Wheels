/**
 * Download images for 2024 Tubular Trucks (Automotive) - 10-col table
 * npx ts-node scripts/tools/download_and_sync_images_2024_silver_series_tubular_trucks.ts
 */
...
const WIKI_URL = 'https://hotwheels.fandom.com/wiki/Tubular_Trucks_Series_(2024)';
const COLLECTION_NAME = 'Hot Wheels Silver Series';
const SERIES_NAME = 'Tubular Trucks (2024)';
const BASE_SUBDIR = 'silver-series/tubular-trucks';
...
async function main() {
  console.log('=== TUBULAR TRUCKS (2024) IMAGE SCRIPT ===');
