/**
 * Comprehensive script to scrape 2024 Hot Wheels Mainline data from Fandom Wiki
 * 
 * This script:
 * 1. Fetches the main table from List_of_2024_Hot_Wheels
...
// Main function
async function main() {
  console.log('🚀 Starting 2024 Mainline Complete Scraper\n');
  ...
  try {
    ...
    const baseImageDir = path.join(process.cwd(), 'public', 'images', 'hotwheels', '2024', 'mainline');
