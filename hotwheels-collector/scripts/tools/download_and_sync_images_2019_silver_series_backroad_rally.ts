...
const WIKI_URL = 'https://hotwheels.fandom.com/wiki/Backroad_Rally_Series_(2019)';
const COLLECTION_NAME = 'Hot Wheels Silver Series';
const SERIES_NAME = 'Backroad Rally (2019)';
const BASE_SUBDIR = 'silver-series/backroad-rally';
...
async function main() {
  console.log('=== BACKROAD RALLY (2019) IMAGE SCRIPT ===');
