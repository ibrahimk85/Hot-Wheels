...
const WIKI_URL = 'https://hotwheels.fandom.com/wiki/SpongeBob_25_Series_(2024)';
const COLLECTION_NAME = 'Hot Wheels Silver Series';
const SERIES_NAME = 'SpongeBob 25 (2024)';
const BASE_SUBDIR = 'silver-series/spongebob-25';
...
async function main() {
  console.log('=== SPONGEBOB 25 (2024) IMAGE SCRIPT ===');
