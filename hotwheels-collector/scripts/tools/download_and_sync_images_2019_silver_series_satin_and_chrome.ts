/**
 * Script to download image assets for 2019 Hot Wheels Silver Series - Satin and Chrome.
 *
 * How to use:
 *   npx ts-node scripts/tools/download_and_sync_images_2019_silver_series_satin_and_chrome.ts
 */
...
const BASE_SUBDIR = 'silver-series/satin-and-chrome';
...
async function main() {
  console.log('=== SATIN AND CHROME (2019) IMAGE DOWNLOAD SCRIPT ===');
