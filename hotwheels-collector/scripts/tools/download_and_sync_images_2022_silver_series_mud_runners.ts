/**
 * Download images for 2022 Mud Runners (Automotive)
 * npx ts-node scripts/tools/download_and_sync_images_2022_silver_series_mud_runners.ts
 */
...
const WIKI_URL = 'https://hotwheels.fandom.com/wiki/Mud_Runners_Series_(2022)';
const COLLECTION_NAME = 'Hot Wheels Silver Series';
const SERIES_NAME = 'Mud Runners (2022)';
...
async function main() {
  console.log('=== MUD RUNNERS (2022) IMAGE SCRIPT ===');
