/**
 * Script to download image assets for the 2023 Hot Wheels Car Culture 2-Packs set and
 * associate them with Model and Variant records in your database.
 *
 * This script performs two jobs:
 *   1. Fetches the 2023 Car Culture 2-Packs page from the Hot Wheels Fandom wiki and
 ...
 *      `public/images/hotwheels/2023/car-culture-2-packs/` folder.
 ...
 *     the 2023 Car Culture 2-Packs variants using the import script.
 ...
 *
 * Usage:
 *   npx ts-node scripts/tools/download_and_sync_images_2023_car_culture_2_packs.ts
 */
