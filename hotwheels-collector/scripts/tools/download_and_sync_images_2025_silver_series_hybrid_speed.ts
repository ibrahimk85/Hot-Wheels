/**
 * Download images for 2025 Hybrid Speed (Automotive) - 8-col table
 * npx ts-node scripts/tools/download_and_sync_images_2025_silver_series_hybrid_speed.ts
 */
...
const WIKI_URL = 'https://hotwheels.fandom.com/wiki/Hybrid_Speed_Series_(2025)';
const COLLECTION_NAME = 'Hot Wheels Silver Series';
const SERIES_NAME = 'Hybrid Speed (2025)';
const BASE_SUBDIR = 'silver-series/hybrid-speed';
...
async function main() {
  console.log('=== HYBRID SPEED (2025) IMAGE SCRIPT ===');
