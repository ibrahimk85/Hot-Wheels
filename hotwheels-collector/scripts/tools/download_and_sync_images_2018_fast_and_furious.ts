/**
 * Script to download image assets for the 2018 Hot Wheels Fast & Furious Series.
 * 
 * This script:
 *   1. Fetches the Fast & Furious Series page from the Hot Wheels Fandom wiki
 *   2. Extracts Photo Carded and Photo Loose image URLs for 2018 year table
 *   3. Downloads images to public/images/hotwheels/2018/fast-and-furious/{castingSlug}/
 ...
 * 
 * How to use:
 *   npx ts-node scripts/tools/download_and_sync_images_2018_fast_and_furious.ts
 */
