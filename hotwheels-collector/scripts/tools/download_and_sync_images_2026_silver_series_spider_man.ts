...
const WIKI_URL = 'https://hotwheels.fandom.com/wiki/Spider-Man_Series_(2026)';
const COLLECTION_NAME = 'Hot Wheels Silver Series';
const SERIES_NAME = 'Spider-Man (2026)';
const BASE_SUBDIR = 'silver-series/spider-man';
...
async function main() {
  console.log('=== SPIDER-MAN (2026) IMAGE SCRIPT ===');
