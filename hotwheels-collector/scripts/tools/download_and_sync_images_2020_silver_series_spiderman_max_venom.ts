...
const WIKI_URL = 'https://hotwheels.fandom.com/wiki/Spider-Man:_Maximum_Venom_Series_(2020)';
const COLLECTION_NAME = 'Hot Wheels Silver Series';
const SERIES_NAME = 'Spider-Man: Maximum Venom (2020)';
const BASE_SUBDIR = 'silver-series/spiderman-max-venom';
...
async function main() {
  console.log('=== Spider-Man: Maximum Venom (2020) IMAGE SCRIPT ===');
