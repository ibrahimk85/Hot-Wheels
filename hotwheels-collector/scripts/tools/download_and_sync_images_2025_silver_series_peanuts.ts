...
const WIKI_URL = 'https://hotwheels.fandom.com/wiki/Peanuts_75_Years_Series_(2025)';
const COLLECTION_NAME = 'Hot Wheels Silver Series';
const SERIES_NAME = 'Peanuts 75 Years (2025)';
const BASE_SUBDIR = 'silver-series/peanuts-75-years';
...
async function main() {
  console.log('=== PEANUTS 75 YEARS (2025) IMAGE SCRIPT ===');
