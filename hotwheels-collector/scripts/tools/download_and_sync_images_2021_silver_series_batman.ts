...
const WIKI_URL = 'https://hotwheels.fandom.com/wiki/Batman_Series_(2021)';
const COLLECTION_NAME = 'Hot Wheels Silver Series';
const SERIES_NAME = 'Batman (2021)';
const BASE_SUBDIR = 'silver-series/batman';
...
async function main() {
  console.log('=== Batman (2021) IMAGE SCRIPT ===');
