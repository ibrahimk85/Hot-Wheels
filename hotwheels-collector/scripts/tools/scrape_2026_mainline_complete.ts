/**
 * Comprehensive script to scrape 2026 Hot Wheels Mainline data from Fandom Wiki
 * 
 * This script:
 * 1. Fetches the main table from List_of_2026_Hot_Wheels
...
const MAINLINE_URL = 'https://hotwheels.fandom.com/wiki/List_of_2026_Hot_Wheels';
...
// Main function
async function main() {
  console.log('🚀 Starting 2026 Mainline Complete Scraper\n');
  ...
  try {
    ...
    const baseImageDir = path.join(process.cwd(), 'public', 'images', 'hotwheels', '2026', 'mainline');
