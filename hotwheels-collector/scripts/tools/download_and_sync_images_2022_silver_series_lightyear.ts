/**
 * Download images for 2022 Lightyear (Entertainment) - 8-col
 * npx ts-node scripts/tools/download_and_sync_images_2022_silver_series_lightyear.ts
 */
...
const WIKI_URL = 'https://hotwheels.fandom.com/wiki/Lightyear_Series_(2022)';
const COLLECTION_NAME = 'Hot Wheels Silver Series';
const SERIES_NAME = 'Lightyear (2022)';
const BASE_SUBDIR = 'silver-series/lightyear';
...
async function main() {
  console.log('=== Lightyear (2022) IMAGE SCRIPT ===');
