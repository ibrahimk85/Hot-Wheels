/**
 * Script to check for duplicate Boulevard models and variants in the database for 2021
 * 
 ...
 * 3. Models without subSeries (which should have Mix1-Mix4)
 */
...
async function main() {
  ...
  console.log(`Expected: 20 models (4 Mix × 5 models each)\n`);
