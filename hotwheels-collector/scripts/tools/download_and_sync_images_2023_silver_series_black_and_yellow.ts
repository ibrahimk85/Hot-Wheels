/**
 * Script to download image assets for 2023 Hot Wheels Silver Series - Black and Yellow 55th Anniversary.
 *
 * This script:
 *   1. Fetches the 55th Anniversary Black and Yellow Series (2023) page from Hot Wheels Fandom wiki
 *   2. Extracts Photo Carded and Photo Loose image URLs from tables
 *   3. Downloads to public/images/hotwheels/2023/silver-series/black-and-yellow/{castingSlug}/
 ...
 *
 * How to use:
 *   npx ts-node scripts/tools/download_and_sync_images_2023_silver_series_black_and_yellow.ts
 */
...
const WIKI_URL = 'https://hotwheels.fandom.com/wiki/55th_Anniversary_Black_and_Yellow_Series_(2023)';
const COLLECTION_NAME = 'Hot Wheels Silver Series';
const SERIES_NAME = 'Black and Yellow 55th Anniversary Series (2023)';
const BASE_SUBDIR = 'silver-series/black-and-yellow';
...
async function main() {
  console.log('=== BLACK AND YELLOW 55TH ANNIVERSARY (2023) IMAGE DOWNLOAD SCRIPT ===');
