/**
 * Download images for 2022 Honda Civic (Automotive)
 * npx ts-node scripts/tools/download_and_sync_images_2022_silver_series_honda_civic.ts
 */
...
const WIKI_URL = 'https://hotwheels.fandom.com/wiki/Honda_Civic_Series_(2022)';
const COLLECTION_NAME = 'Hot Wheels Silver Series';
const SERIES_NAME = 'Honda Civic (2022)';
const BASE_SUBDIR = 'silver-series/honda-civic';
...
async function main() {
  console.log('=== HONDA CIVIC (2022) IMAGE SCRIPT ===');
