...
const WIKI_URL = 'https://hotwheels.fandom.com/wiki/AcceleRacers_Series_(2025)';
const COLLECTION_NAME = 'Hot Wheels Silver Series';
const SERIES_NAME = 'AcceleRacers (2025)';
const BASE_SUBDIR = 'silver-series/acceleracers';
...
async function main() {
  console.log('=== ACCELERACERS (2025) IMAGE SCRIPT ===');
