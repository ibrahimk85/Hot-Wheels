/**
 * Script to download images for 2021 Pearl&Chrome Anniversary Series (Orange and Blue Series).
 *
 * How to use:
 *   npx ts-node scripts/tools/download_pearl_chrome_anniversary_2021.ts
 */
