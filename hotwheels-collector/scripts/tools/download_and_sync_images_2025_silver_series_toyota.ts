/**
 * Download images for 2025 Toyota (Automotive) - 8-col table
 * npx ts-node scripts/tools/download_and_sync_images_2025_silver_series_toyota.ts
 */
...
const WIKI_URL = 'https://hotwheels.fandom.com/wiki/Toyota_Series_(2025)';
const COLLECTION_NAME = 'Hot Wheels Silver Series';
const SERIES_NAME = 'Toyota (2025)';
const BASE_SUBDIR = 'silver-series/toyota';
...
async function main() {
  console.log('=== TOYOTA (2025) IMAGE SCRIPT ===');
