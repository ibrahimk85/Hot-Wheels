/**
 * Script to download images for 2025 Pearl&Chrome Anniversary Series (Purple and Gold Series).
 *
 * How to use:
 *   npx ts-node scripts/tools/download_pearl_chrome_anniversary_2025.ts
 */
