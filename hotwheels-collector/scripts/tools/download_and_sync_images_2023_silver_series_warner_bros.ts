/**
 * Download images for 2020 Fast & Furious (Automotive) - 8-col: Series # | Toy # | Casting | Color | Tampos | Wheel Type | Notes | Photo - Car | Photo - Card
 * npx ts-node scripts/tools/download_and_sync_images_2020_silver_series_fast_and_furious.ts
 */
...
const WIKI_URL = 'https://hotwheels.fandom.com/wiki/Warner_Bros._100th_Anniversary_Series_(2023)';
const COLLECTION_NAME = 'Hot Wheels Silver Series';
const SERIES_NAME = 'Warner Bros. 100th Anniversary (2023)';
const BASE_SUBDIR = 'silver-series/warner-bros-100';
...
async function main() {
  console.log('=== WARNER BROS. 100TH ANNIVERSARY (2023) IMAGE SCRIPT ===');
