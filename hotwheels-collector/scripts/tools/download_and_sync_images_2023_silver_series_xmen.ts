...
const WIKI_URL = 'https://hotwheels.fandom.com/wiki/X-Men_Series_(2023)';
const COLLECTION_NAME = 'Hot Wheels Silver Series';
const SERIES_NAME = 'X-Men (2023)';
const BASE_SUBDIR = 'silver-series/x-men';
...
async function main() {
  console.log('=== X-MEN (2023) IMAGE SCRIPT ===');
