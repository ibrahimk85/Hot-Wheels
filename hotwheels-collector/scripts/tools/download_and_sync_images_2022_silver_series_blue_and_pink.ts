/**
 * Script to download image assets for 2022 Hot Wheels Silver Series - Blue and Pink.
 *
 * This script:
 ...
 *   3. Downloads to public/images/hotwheels/2022/silver-series/blue-and-pink/{castingSlug}/
 *   4. Associates images with Variant records
 *
 * How to use:
 *   npx ts-node scripts/tools/download_and_sync_images_2022_silver_series_blue_and_pink.ts
 */
...
const WIKI_URL = 'https://hotwheels.fandom.com/wiki/Blue_and_Pink_Series_(2022)';
const COLLECTION_NAME = 'Hot Wheels Silver Series';
const SERIES_NAME = 'Blue and Pink (2022)';
const BASE_SUBDIR = 'silver-series/blue-and-pink';
...
async function main() {
  console.log('=== BLUE AND PINK (2022) IMAGE DOWNLOAD SCRIPT ===');
