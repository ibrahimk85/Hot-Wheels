/**
 * Comprehensive script to scrape 2023 Hot Wheels Mainline data from Fandom Wiki
 * 
 * This script:
 * 1. Fetches the main table from List_of_2023_Hot_Wheels
 ...
 * 
 * Usage:
 *   npx ts-node scripts/tools/scrape_2023_mainline_complete.ts
 */
...
// Main function
async function main() {
  console.log('🚀 Starting 2023 Mainline Complete Scraper\n');
  ...
  try {
    ...
    const baseImageDir = path.join(process.cwd(), 'public', 'images', 'hotwheels', '2023', 'mainline');
