/**
 * Download images for 2021 Hot Pickups (Automotive) - 8-col table
 * npx ts-node scripts/tools/download_and_sync_images_2021_silver_series_hot_pickups.ts
 */
...
const WIKI_URL = 'https://hotwheels.fandom.com/wiki/Hot_Pickups_Series_(2021)';
const COLLECTION_NAME = 'Hot Wheels Silver Series';
const SERIES_NAME = 'Hot Pickups (2021)';
const BASE_SUBDIR = 'silver-series/hot-pickups';
...
async function main() {
  console.log('=== HOT PICKUPS (2021) IMAGE SCRIPT ===');
