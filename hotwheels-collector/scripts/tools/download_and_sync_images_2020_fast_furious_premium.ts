/**
 * Download Fast & Furious Premium wiki images for 2020 (403-safe fetch + CDN binary download).
 *
 *   npx ts-node scripts/tools/download_and_sync_images_2020_fast_furious_premium.ts
 */
