/**
 * Script to download image assets for the 2023 Hot Wheels Boulevard series.
 * 
 * This script:
 *   1. Fetches the Boulevard table from the Hot Wheels Fandom wiki
 *   2. Extracts Photo Carded and Photo Loose image URLs
 *   3. Downloads images to public/images/hotwheels/2023/boulevard/{castingSlug}/
 ...
 * 
 * How to use:
 *   npx ts-node scripts/tools/download_and_sync_images_2023_boulevard.ts
 */
