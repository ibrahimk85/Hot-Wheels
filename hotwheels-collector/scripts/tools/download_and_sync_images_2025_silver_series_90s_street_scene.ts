/**
 * Download images for 2025 '90s Street Scene (Automotive) - 10-col table
 * npx ts-node scripts/tools/download_and_sync_images_2025_silver_series_90s_street_scene.ts
 */
...
const WIKI_URL = "https://hotwheels.fandom.com/wiki/%2790s_Street_Scene_Series_(2025)";
const COLLECTION_NAME = 'Hot Wheels Silver Series';
const SERIES_NAME = "'90s Street Scene (2025)";
const BASE_SUBDIR = 'silver-series/90s-street-scene';
...
async function main() {
  console.log("=== '90s STREET SCENE (2025) IMAGE SCRIPT ===");
