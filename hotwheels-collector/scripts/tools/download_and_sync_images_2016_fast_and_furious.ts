/**
 * Script to download image assets for the 2016 Hot Wheels Fast & Furious Series.
 * 
 * This script:
 *   1. Fetches the Fast & Furious Series page from the Hot Wheels Fandom wiki
 *   2. Extracts Photo Carded and Photo Loose image URLs for 2016 year table
 *   3. Downloads images to public/images/hotwheels/2016/fast-and-furious/{castingSlug}/
 ...
 * 
 * 2016 Table Structure (9 columns):
 ...
 * 
 * How to use:
 *   npx ts-node scripts/tools/download_and_sync_images_2016_fast_and_furious.ts
 */
