...
const WIKI_URL = 'https://hotwheels.fandom.com/wiki/Fast_%26_Furious_Series_(2020)';
const COLLECTION_NAME = 'Hot Wheels Silver Series';
const SERIES_NAME = 'Fast & Furious (2020)';
const BASE_SUBDIR = 'silver-series/fast-and-furious';
...
async function main() {
  console.log('=== FAST & FURIOUS (2020) IMAGE SCRIPT ===');
