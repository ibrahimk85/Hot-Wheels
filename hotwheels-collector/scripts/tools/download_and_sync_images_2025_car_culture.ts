/**
 * Script to download image assets for the 2025 Hot Wheels Car Culture series.
 * 
 * This script:
 *   1. Fetches the Car Culture table from the Hot Wheels Fandom wiki
 *   2. Extracts Photo Carded and Photo Loose image URLs
 *   3. Downloads images to public/images/hotwheels/2025/car-culture/{castingSlug}/
 ...
 * 
 * How to use:
 *   npx ts-node scripts/tools/download_and_sync_images_2025_car_culture.ts
 */
