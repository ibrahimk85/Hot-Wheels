/**
 * Download images for 2022 World Class Racers (Automotive)
 * npx ts-node scripts/tools/download_and_sync_images_2022_silver_series_world_class_racers.ts
 */
...
const WIKI_URL = 'https://hotwheels.fandom.com/wiki/World_Class_Racers_Series_(2022)';
const COLLECTION_NAME = 'Hot Wheels Silver Series';
const SERIES_NAME = 'World Class Racers (2022)';
const BASE_SUBDIR = 'silver-series/world-class-racers';
...
async function main() {
  console.log('=== WORLD CLASS RACERS (2022) IMAGE SCRIPT ===');
