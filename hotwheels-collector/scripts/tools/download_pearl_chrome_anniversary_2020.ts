/**
 * Script to download images for 2020 Pearl&Chrome Anniversary Series (Pearl and Chrome Series).
 *
 * How to use:
 *   npx ts-node scripts/tools/download_pearl_chrome_anniversary_2020.ts
 */
