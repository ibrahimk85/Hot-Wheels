...
async function main() {
  console.log('Testing 2011 Mainline data and images...\n');
  ...
  if (!mainlineCollection) {
    console.error('2011 Mainline collection not found!');
    return;
  }

  // Get all variants for 2011 Mainline
  ...
  console.log(`Total 2011 Mainline variants: ${allVariants.length}\n`);
  ...
  console.log(`Toy# Status (CRITICAL for 2011):`);
