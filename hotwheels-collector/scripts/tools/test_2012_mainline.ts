...
async function main() {
  console.log('Testing 2012 Mainline data and images...\n');
  ...
  if (!mainlineCollection) {
    console.error('2012 Mainline collection not found!');
    return;
  }

  // Get all variants for 2012 Mainline
  ...
  console.log(`Total 2012 Mainline variants: ${allVariants.length}\n`);
  ...
  console.log(`Toy# Status (CRITICAL for 2012):`);
