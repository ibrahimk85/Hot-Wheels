...
const WIKI_URL = 'https://hotwheels.fandom.com/wiki/Honda_70th_Anniversary_Series_(2018)';
const COLLECTION_NAME = 'Hot Wheels Silver Series';
const SERIES_NAME = 'Honda 70th Anniversary (2018)';
const BASE_SUBDIR = 'silver-series/honda-70th';
...
async function main() {
  console.log('=== HONDA 70TH (2018) IMAGE SCRIPT ===');
