...
const WIKI_URL = 'https://hotwheels.fandom.com/wiki/Avatar:_The_Last_Airbender_Series_(2025)';
const COLLECTION_NAME = 'Hot Wheels Silver Series';
const SERIES_NAME = 'Avatar: The Last Airbender (2025)';
const BASE_SUBDIR = 'silver-series/avatar';
...
async function main() {
  console.log('=== AVATAR: THE LAST AIRBENDER (2025) IMAGE SCRIPT ===');
