/**
 * Script to download image assets for the 2024 Hot Wheels Pop Culture series.
 * 
 * This script:
 *   1. Fetches the Pop Culture table from the Hot Wheels Fandom wiki
 *   2. Extracts Photo Carded and Photo Loose image URLs
 *   3. Downloads images to public/images/hotwheels/2024/pop-culture/{castingSlug}/
        ...
        if (looseImgUrlRaw) {
          ...
          const existingLooseImage = await prisma.image.findFirst({
            where: {
              ...
              path: {
                contains: `${sanitizeFileName(toyNumber)}_loose`,
              },
            },
          });
