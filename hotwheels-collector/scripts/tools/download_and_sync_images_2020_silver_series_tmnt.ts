...
const WIKI_URL = 'https://hotwheels.fandom.com/wiki/Teenage_Mutant_Ninja_Turtles_Series_(2020)';
const COLLECTION_NAME = 'Hot Wheels Silver Series';
const SERIES_NAME = 'Teenage Mutant Ninja Turtles (2020)';
const BASE_SUBDIR = 'silver-series/tmnt';
...
async function main() {
  console.log('=== Teenage Mutant Ninja Turtles (2020) IMAGE SCRIPT ===');
