...
const WIKI_URL = 'https://hotwheels.fandom.com/wiki/Toy_Story_Series_(2019)';
const COLLECTION_NAME = 'Hot Wheels Silver Series';
const SERIES_NAME = 'Toy Story (2019)';
const BASE_SUBDIR = 'silver-series/toy-story';
...
async function main() {
  console.log('=== Toy Story (2019) IMAGE SCRIPT ===');
