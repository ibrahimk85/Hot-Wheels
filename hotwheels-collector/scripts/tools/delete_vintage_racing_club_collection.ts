/**
 * Vintage Racing Club koleksiyonunu tamamen siler.
 * Tüm yıllardaki aynı isimli koleksiyon kayıtları, alt serileri, modelleri ve varyantları silinir.
 * Dashboard, Variants ve Collections sayfalarından bu koleksiyon kalkar (veri tek kaynak: DB).
 *
 * Kullanım: npx ts-node scripts/tools/delete_vintage_racing_club_collection.ts
 */
import 'dotenv/config';
import { PrismaClient } from '@prisma/client';

const COLLECTION_NAME = 'Vintage Racing Club';
