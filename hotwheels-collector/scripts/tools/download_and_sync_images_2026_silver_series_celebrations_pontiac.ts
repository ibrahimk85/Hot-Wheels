/**
 * Download images for 2026 Celebrations - Pontiac 100th Anniversary (Automotive) - 10-col
 * npx ts-node scripts/tools/download_and_sync_images_2026_silver_series_celebrations_pontiac.ts
 */
...
const WIKI_URL = 'https://hotwheels.fandom.com/wiki/Pontiac_100th_Anniversary_Series_(2026)';
const COLLECTION_NAME = 'Hot Wheels Silver Series';
const SERIES_NAME = 'Celebrations - Pontiac 100th Anniversary (2026)';
const BASE_SUBDIR = 'silver-series/celebrations/pontiac-100th';
...
// 10-col: Series# | Toy# | Casting | Color | Tampos | Base | Wheel Type | Notes | Photo Loose | Photo Carded
...
async function main() {
  console.log('=== Celebrations - Pontiac 100th Anniversary (2026) IMAGE SCRIPT ===');
