/**
 * One-off / idempotent: 2001 wiki Final Run uses Toy# that also appear in open stock.
 * Merges "2001 Final Run" → "Final Run", dedupes by Toy#, sets releaseName.
 *
 *   npx ts-node scripts/tools/fix_2001_final_run_subseries.ts
 *
 * Toy#s from List_of_2001_Hot_Wheels Final Run (2001).
 */
...
const LEGACY_FINAL_RUN = '2001 Final Run';
const FINAL_RUN_TOY_NUMBERS = [
  '26992',
  '26993',
  '26994',
  '26995',
...
async function main() {
  ...
  console.log('\n✅ 2001 Final Run subseries fix done.');
}
