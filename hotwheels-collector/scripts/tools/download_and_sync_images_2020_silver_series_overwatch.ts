...
const WIKI_URL = 'https://hotwheels.fandom.com/wiki/Overwatch_Series_(2020)';
const COLLECTION_NAME = 'Hot Wheels Silver Series';
const SERIES_NAME = 'Overwatch (2020)';
const BASE_SUBDIR = 'silver-series/overwatch';
...
async function main() {
  console.log('=== Overwatch (2020) IMAGE SCRIPT ===');
