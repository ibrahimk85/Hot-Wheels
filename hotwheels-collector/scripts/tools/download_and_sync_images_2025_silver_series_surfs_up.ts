/**
 * Download images for 2025 Surf's Up (Automotive) - 8-col table
 * npx ts-node scripts/tools/download_and_sync_images_2025_silver_series_surfs_up.ts
 */
...
const WIKI_URL = "https://hotwheels.fandom.com/wiki/Surf%27s_Up_Series_(2025)";
const COLLECTION_NAME = 'Hot Wheels Silver Series';
const SERIES_NAME = "Surf's Up (2025)";
const BASE_SUBDIR = 'silver-series/surfs-up';
...
async function main() {
  console.log("=== SURF'S UP (2025) IMAGE SCRIPT ===");
