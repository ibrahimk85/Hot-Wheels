...
const WIKI_URL = 'https://hotwheels.fandom.com/wiki/Off_Road_Trucks_Series_(2019)';
const COLLECTION_NAME = 'Hot Wheels Silver Series';
const SERIES_NAME = 'Off Road Trucks (2019)';
const BASE_SUBDIR = 'silver-series/off-road-trucks';
...
async function main() {
  console.log('=== OFF ROAD TRUCKS (2019) IMAGE SCRIPT ===');
