/**
 * Download images for 2024 Hot Wagons (Automotive) - 8-col table
 * npx ts-node scripts/tools/download_and_sync_images_2024_silver_series_hot_wagons.ts
 */
...
const WIKI_URL = 'https://hotwheels.fandom.com/wiki/Hot_Wagons_Series_(2024)';
const COLLECTION_NAME = 'Hot Wheels Silver Series';
const SERIES_NAME = 'Hot Wagons (2024)';
const BASE_SUBDIR = 'silver-series/hot-wagons';
...
async function main() {
  console.log('=== HOT WAGONS (2024) IMAGE SCRIPT ===');
