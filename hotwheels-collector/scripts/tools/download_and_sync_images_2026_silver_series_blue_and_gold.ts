/**
 * Script to download image assets for 2026 Hot Wheels Silver Series - Blue and Gold.
 *
 * This script:
 *   1. Fetches the Blue and Gold Series (2026) page from Hot Wheels Fandom wiki
 *   2. Extracts Photo Carded and Photo Loose image URLs from tables
 *   3. Downloads to public/images/hotwheels/2026/silver-series/blue-and-gold/{castingSlug}/
 ...
 *
 * How to use:
 *   npx ts-node scripts/tools/download_and_sync_images_2026_silver_series_blue_and_gold.ts
 */
...
const WIKI_URL = 'https://hotwheels.fandom.com/wiki/Blue_and_Gold_Series_(2026)';
const COLLECTION_NAME = 'Hot Wheels Silver Series';
const SERIES_NAME = 'Blue and Gold (2026)';
const BASE_SUBDIR = 'silver-series/blue-and-gold';
...
async function main() {
  console.log('=== BLUE AND GOLD (2026) IMAGE DOWNLOAD SCRIPT ===');
  ...
  for (let tableIdx = 0; tableIdx < tables.length; tableIdx++) {
    ...
    for (let i = 0; i < rows.length; i++) {
      ...
      // Blue and Gold: Photo Loose = col 7, Photo Carded = col 8
      const looseColIdx = 7;
