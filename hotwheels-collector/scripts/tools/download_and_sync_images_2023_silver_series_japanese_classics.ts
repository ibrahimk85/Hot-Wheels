/**
 * Download images for 2023 Japanese Classics (Automotive) - 8-col table
 * npx ts-node scripts/tools/download_and_sync_images_2023_silver_series_japanese_classics.ts
 */
...
const WIKI_URL = 'https://hotwheels.fandom.com/wiki/Japanese_Classics_Series_(2023)';
const COLLECTION_NAME = 'Hot Wheels Silver Series';
const SERIES_NAME = 'Japanese Classics (2023)';
const BASE_SUBDIR = 'silver-series/japanese-classics';
...
async function main() {
  console.log('=== JAPANESE CLASSICS (2023) IMAGE SCRIPT ===');
