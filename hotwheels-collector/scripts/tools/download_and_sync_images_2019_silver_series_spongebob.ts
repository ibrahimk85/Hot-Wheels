...
const WIKI_URL = 'https://hotwheels.fandom.com/wiki/SpongeBob_SquarePants_Series_(2019)';
const COLLECTION_NAME = 'Hot Wheels Silver Series';
const SERIES_NAME = 'SpongeBob SquarePants (2019)';
const BASE_SUBDIR = 'silver-series/spongebob';
...
async function main() {
  console.log('=== SpongeBob SquarePants (2019) IMAGE SCRIPT ===');
