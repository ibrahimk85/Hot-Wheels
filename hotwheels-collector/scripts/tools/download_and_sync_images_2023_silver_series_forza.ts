/**
 * Download images for 2023 Forza (Automotive) - 8-col table
 * npx ts-node scripts/tools/download_and_sync_images_2023_silver_series_forza.ts
 */
...
const WIKI_URL = 'https://hotwheels.fandom.com/wiki/Forza_Series_(2023)';
const COLLECTION_NAME = 'Hot Wheels Silver Series';
const SERIES_NAME = 'Forza (2023)';
const BASE_SUBDIR = 'silver-series/forza';
...
async function main() {
  console.log('=== FORZA (2023) IMAGE SCRIPT ===');
