...
const WIKI_URL = 'https://hotwheels.fandom.com/wiki/Toy_Story_5_Series_(2026)';
const COLLECTION_NAME = 'Hot Wheels Silver Series';
const SERIES_NAME = 'Toy Story 5 (2026)';
const BASE_SUBDIR = 'silver-series/toy-story-5';
...
async function main() {
  console.log('=== TOY STORY 5 (2026) IMAGE SCRIPT ===');
