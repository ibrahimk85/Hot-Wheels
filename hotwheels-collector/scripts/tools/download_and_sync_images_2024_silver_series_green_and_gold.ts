/**
 * Script to download image assets for 2024 Hot Wheels Silver Series - Green and Gold.
 *
 * This script:
 *   1. Fetches the Green and Gold Series (2024) page from Hot Wheels Fandom wiki
 *   2. Extracts Photo Carded and Photo Loose image URLs from tables
 *   3. Downloads to public/images/hotwheels/2024/silver-series/green-and-gold/{castingSlug}/
 ...
 *
 * How to use:
 *   npx ts-node scripts/tools/download_and_sync_images_2024_silver_series_green_and_gold.ts
 */
...
const WIKI_URL = 'https://hotwheels.fandom.com/wiki/Green_and_Gold_Series_(2024)';
const COLLECTION_NAME = 'Hot Wheels Silver Series';
const SERIES_NAME = 'Green and Gold (2024)';
const BASE_SUBDIR = 'silver-series/green-and-gold';
...
async function main() {
  console.log('=== GREEN AND GOLD (2024) IMAGE DOWNLOAD SCRIPT ===');
