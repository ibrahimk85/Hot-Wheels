...
const WIKI_URL = 'https://hotwheels.fandom.com/wiki/Exotics_Series_(2019)';
const COLLECTION_NAME = 'Hot Wheels Silver Series';
const SERIES_NAME = 'Exotics (2019)';
const BASE_SUBDIR = 'silver-series/exotics';
...
async function main() {
  console.log('=== EXOTICS (2019) IMAGE SCRIPT ===');
