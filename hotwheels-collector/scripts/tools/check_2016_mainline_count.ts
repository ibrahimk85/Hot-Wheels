/**
 * Check 2016 Mainline variant count and max COL#
 */
...
async function main() {
  ...
  console.log(`Total 2016 Mainline variants: ${variants.length}`);
  ...
  if (numericCols.length > 0) {
    ...
    console.log('\nNo numeric COL# found. Check if import was successful.');
  }
}
