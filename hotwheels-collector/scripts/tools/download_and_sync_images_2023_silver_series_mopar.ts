/**
 * Download images for 2023 Mopar (Automotive) - 8-col table
 * npx ts-node scripts/tools/download_and_sync_images_2023_silver_series_mopar.ts
 */
...
const WIKI_URL = 'https://hotwheels.fandom.com/wiki/Mopar_Series_(2023)';
const COLLECTION_NAME = 'Hot Wheels Silver Series';
const SERIES_NAME = 'Mopar (2023)';
const BASE_SUBDIR = 'silver-series/mopar';
...
async function main() {
  console.log('=== MOPAR (2023) IMAGE SCRIPT ===');
