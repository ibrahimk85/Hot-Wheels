/**
 * Script to download image assets for the 2025 Hot Wheels Fast & Furious Series.
 * 
 * This script:
 *   1. Fetches 4 Fast & Furious Series pages from the Hot Wheels Fandom wiki
 *   2. Extracts Photo Carded and Photo Loose image URLs for 2025 year tables
 *   3. Downloads images to public/images/hotwheels/2025/fast-and-furious/{castingSlug}/
 ...
 * - Supports 4 sub-series: Brian O'Conner, Villains, Racing Course, Graphic Remix
 * 
 * How to use:
 *   npx ts-node scripts/tools/download_and_sync_images_2025_fast_and_furious.ts
 */
...
const URLS = [
  {
    url: 'https://hotwheels.fandom.com/wiki/Fast_%26_Furious:_Brian_O%27Conner_Series_(2025)',
    subSeriesName: "Brian O'Conner",
  },
  {
    url: 'https://hotwheels.fandom.com/wiki/Fast_%26_Furious:_Villains_Series_(2025)',
    subSeriesName: 'Villains',
  },
  {
    url: 'https://hotwheels.fandom.com/wiki/Fast_%26_Furious:_Racing_Course_Series_(2025)',
    subSeriesName: 'Racing Course',
  },
  {
    url: 'https://hotwheels.fandom.com/wiki/Fast_%26_Furious:_Graphic_Remix_Series_(2025)',
    subSeriesName: 'Graphic Remix',
  },
];
...
async function main() {
  ...
  for (const { url, subSeriesName } of URLS) {
    ...
    // Find the main table (should be the first wikitable)
    ...
    for (let i = 0; i < rows.length; i++) {
      ...
      // 2025 table structure (same as 2024):
      ...
      // Process Photo Carded (main image) - Column 10
      const photoCardedColIdx = 10;
      ...
      // Process Photo Loose (second image) - Column 9
      const photoLooseColIdx = 9;
