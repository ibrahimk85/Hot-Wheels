...
const WIKI_URL = 'https://hotwheels.fandom.com/wiki/Disney_100_Holiday_Series_(2023)';
const COLLECTION_NAME = 'Hot Wheels Silver Series';
const SERIES_NAME = 'Disney 100 Holiday (2023)';
const BASE_SUBDIR = 'silver-series/disney-100-holiday';
...
async function main() {
  console.log('=== DISNEY 100 HOLIDAY (2023) IMAGE SCRIPT ===');
