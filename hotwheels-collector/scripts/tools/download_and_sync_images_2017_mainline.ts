/**
 * Script to download image assets for the 2017 Hot Wheels Mainline and
 * associate them with Variant records in your database.
 *
 * This script performs two jobs:
 *   1. Fetches the 2017 mainline table from the Hot Wheels Fandom wiki and
 ...
 *      `public/images/hotwheels/2017/mainline/{castingSlug}/` folder. The
 ...
 *     the 2017 mainline variants using the import script provided earlier.
 ...
 *
 *   3. Run with ts-node:
 *        npx ts-node scripts/tools/download_and_sync_images_2017_mainline.ts
 */
...
const MAINLINE_URL = 'https://hotwheels.fandom.com/wiki/List_of_2017_Hot_Wheels';
...
async function main() {
  console.log('Fetching 2017 mainline page…');
  ...
  // public/images/hotwheels/2017/mainline/
  ...
  for (let i = 0; i < rows.length; i++) {
    ...
    if (!mainlineCollection) {
      console.warn('2017 Mainline collection not found; skipping image association.');
      continue;
    }
