/**
 * Download images for 2023 Mud Runners (Automotive) - 8-col table
 * npx ts-node scripts/tools/download_and_sync_images_2023_silver_series_mud_runners.ts
 */
...
const WIKI_URL = 'https://hotwheels.fandom.com/wiki/Mud_Runners_Series_(2023)';
const COLLECTION_NAME = 'Hot Wheels Silver Series';
const SERIES_NAME = 'Mud Runners (2023)';
const BASE_SUBDIR = 'silver-series/mud-runners';
...
async function main() {
  console.log('=== MUD RUNNERS (2023) IMAGE SCRIPT ===');
