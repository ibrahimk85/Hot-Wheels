/**
 * Script to download images for 2023 Pearl&Chrome Anniversary Series (55th Anniversary Black and Yellow Series).
 *
 * How to use:
 *   npx ts-node scripts/tools/download_pearl_chrome_anniversary_2023.ts
 */
