...
const WIKI_URL = 'https://hotwheels.fandom.com/wiki/Ford_Trucks_Series_(2018)';
const COLLECTION_NAME = 'Hot Wheels Silver Series';
const SERIES_NAME = 'Ford Trucks (2018)';
const BASE_SUBDIR = 'silver-series/ford-trucks';
...
async function main() {
  console.log('=== FORD TRUCKS (2018) IMAGE SCRIPT ===');
