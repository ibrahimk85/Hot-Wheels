...
async function check2024ImageMatching() {
  console.log('=== Checking 2024 Mainline Image Matching ===\n');

  // Get all 2024 Mainline variants
  ...
  console.log(`Total 2024 Mainline variants: ${variants.length}\n`);
