...
const WIKI_URL = 'https://hotwheels.fandom.com/wiki/Transformers_Series_(2024)';
const COLLECTION_NAME = 'Hot Wheels Silver Series';
const SERIES_NAME = 'Transformers (2024)';
const BASE_SUBDIR = 'silver-series/transformers';
...
async function main() {
  console.log('=== TRANSFORMERS (2024) IMAGE SCRIPT ===');
