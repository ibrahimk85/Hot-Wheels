...
const WIKI_URL = 'https://hotwheels.fandom.com/wiki/Forza_Horizon_4_Series_(2019)';
const COLLECTION_NAME = 'Hot Wheels Silver Series';
const SERIES_NAME = 'Forza Horizon 4 (2019)';
const BASE_SUBDIR = 'silver-series/forza-horizon-4';
...
async function main() {
  console.log('=== FORZA HORIZON 4 (2019) IMAGE SCRIPT ===');
