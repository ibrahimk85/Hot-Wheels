/**
 * Download images for 2026 Rally Racers (Automotive)
 * npx ts-node scripts/tools/download_and_sync_images_2026_silver_series_rally_racers.ts
 */
...
const WIKI_URL = 'https://hotwheels.fandom.com/wiki/Rally_Racers_Series_(2026)';
const COLLECTION_NAME = 'Hot Wheels Silver Series';
const SERIES_NAME = 'Rally Racers (2026)';
const BASE_SUBDIR = 'silver-series/rally-racers';
...
async function main() {
  console.log('=== RALLY RACERS (2026) IMAGE SCRIPT ===');
