/**
 * Download Fast & Furious Premium wiki images for 2023 (403-safe fetch + CDN binary download).
 * Skips Bundle 1–3 tables (same as import).
 *
 *   npx ts-node scripts/tools/download_and_sync_images_2023_fast_furious_premium.ts
 */
