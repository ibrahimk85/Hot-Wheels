/**
 * Script to download image assets for the 2024 Hot Wheels Fast & Furious Series.
 * 
 * This script:
 *   1. Fetches 4 Fast & Furious Series pages from the Hot Wheels Fandom wiki
 *   2. Extracts Photo Carded and Photo Loose image URLs for 2024 year tables
 *   3. Downloads images to public/images/hotwheels/2024/fast-and-furious/{castingSlug}/
 ...
 * - Supports 4 sub-series: Women of Fast, HW Decades, Dominic Toretto, Racing Series
 * 
 * How to use:
 *   npx ts-node scripts/tools/download_and_sync_images_2024_fast_and_furious.ts
 */
