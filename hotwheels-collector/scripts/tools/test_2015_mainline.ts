...
async function main() {
  console.log('Testing 2015 Mainline data and images...\n');
  ...
  if (!mainlineCollection) {
    console.error('2015 Mainline collection not found!');
    return;
  }

  // Get all variants for 2015 Mainline
  ...
  console.log(`Total 2015 Mainline variants: ${allVariants.length}\n`);
  ...
  console.log(`Toy# Status (CRITICAL for 2015):`);
