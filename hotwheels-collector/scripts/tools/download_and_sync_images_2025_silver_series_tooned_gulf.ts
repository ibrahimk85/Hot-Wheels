/**
 * Download images for 2025 Tooned Gulf (Automotive) - 10-col table
 * npx ts-node scripts/tools/download_and_sync_images_2025_silver_series_tooned_gulf.ts
 */
...
const WIKI_URL = 'https://hotwheels.fandom.com/wiki/Tooned_Gulf_Series_(2025)';
const COLLECTION_NAME = 'Hot Wheels Silver Series';
const SERIES_NAME = 'Tooned Gulf (2025)';
const BASE_SUBDIR = 'silver-series/tooned-gulf';
...
async function main() {
  console.log('=== TOONED GULF (2025) IMAGE SCRIPT ===');
