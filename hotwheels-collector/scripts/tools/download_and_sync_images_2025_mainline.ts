/**
 * Script to download image assets for the 2025 Hot Wheels Mainline and
 * associate them with Variant records in your database.
 *
 * This script performs two jobs:
 *   1. Fetches the 2025 mainline table from the Hot Wheels Fandom wiki and
 ...
 *      `public/images/hotwheels/2025/mainline/{castingSlug}/` folder. The
 ...
 *     the 2025 mainline variants using the import script provided earlier.
 ...
 *
 *   3. Run with ts-node:
 *        npx ts-node scripts/tools/download_and_sync_images_2025_mainline.ts
 */
...
async function main() {
  console.log('Fetching 2025 mainline page…');
