...
const WIKI_URL = 'https://hotwheels.fandom.com/wiki/The_Muppets_Series_(2021)';
const COLLECTION_NAME = 'Hot Wheels Silver Series';
const SERIES_NAME = 'The Muppets (2021)';
const BASE_SUBDIR = 'silver-series/muppets';
...
async function main() {
  console.log('=== The Muppets (2021) IMAGE SCRIPT ===');
