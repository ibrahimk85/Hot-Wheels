...
const WIKI_URL = 'https://hotwheels.fandom.com/wiki/Avengers_Series_(2019)';
const COLLECTION_NAME = 'Hot Wheels Silver Series';
const SERIES_NAME = 'Avengers (2019)';
const BASE_SUBDIR = 'silver-series/avengers';
...
async function main() {
  console.log('=== Avengers (2019) IMAGE SCRIPT ===');
