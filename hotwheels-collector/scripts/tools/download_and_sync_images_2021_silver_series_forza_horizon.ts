/**
 * Download images for 2021 Forza Horizon (Automotive) - 8-col: Col # | Toy # | Casting | Body Color | Wheel | Notes | Photo Loose | Photo Card
 * npx ts-node scripts/tools/download_and_sync_images_2021_silver_series_forza_horizon.ts
 */
...
const WIKI_URL = 'https://hotwheels.fandom.com/wiki/Forza_Horizon_Series_(2021)';
const COLLECTION_NAME = 'Hot Wheels Silver Series';
const SERIES_NAME = 'Forza Horizon (2021)';
const BASE_SUBDIR = 'silver-series/forza-horizon';
...
async function main() {
  console.log('=== FORZA HORIZON (2021) IMAGE SCRIPT ===');
