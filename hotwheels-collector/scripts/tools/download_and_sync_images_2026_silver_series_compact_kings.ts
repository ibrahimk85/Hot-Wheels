/**
 * Download images for 2026 Compact Kings (Automotive)
 * Table: Series # | Toy # | Casting Name | Color | Tampos | Base Color/Type | Wheel Type | Notes | Photo Loose | Photo Carded
 * npx ts-node scripts/tools/download_and_sync_images_2026_silver_series_compact_kings.ts
 */
...
const WIKI_URL = 'https://hotwheels.fandom.com/wiki/Compact_Kings_Series_(2026)';
const COLLECTION_NAME = 'Hot Wheels Silver Series';
const SERIES_NAME = 'Compact Kings (2026)';
const BASE_SUBDIR = 'silver-series/compact-kings';
...
async function main() {
  console.log('=== COMPACT KINGS (2026) IMAGE SCRIPT ===');
