/**
 * Download Fast & Furious Premium wiki images for 2024 (403-safe fetch + CDN binary download).
 *
 *   npx ts-node scripts/tools/download_and_sync_images_2024_fast_furious_premium.ts
 */
...
async function main() {
  ...
  const yearTables = $('table.wikitable');
