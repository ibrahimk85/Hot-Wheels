/**
 * Download images for 2024 J-Imports (Automotive) - 8-col table
 * npx ts-node scripts/tools/download_and_sync_images_2024_silver_series_j_imports.ts
 */
...
const WIKI_URL = 'https://hotwheels.fandom.com/wiki/Hot_Wheels_J-Imports_Series_(2024)';
const COLLECTION_NAME = 'Hot Wheels Silver Series';
const SERIES_NAME = 'J-Imports (2024)';
const BASE_SUBDIR = 'silver-series/j-imports';
...
async function main() {
  console.log('=== J-IMPORTS (2024) IMAGE SCRIPT ===');
