...
const WIKI_URL = 'https://hotwheels.fandom.com/wiki/Spider-Man:_Into_the_Spider-Verse_Series_(2018)';
const COLLECTION_NAME = 'Hot Wheels Silver Series';
const SERIES_NAME = 'Spider-Man: Into the Spider-Verse (2018)';
const BASE_SUBDIR = 'silver-series/spiderverse';
...
async function main() {
  console.log('=== Spider-Man: Into the Spider-Verse (2018) IMAGE SCRIPT ===');
