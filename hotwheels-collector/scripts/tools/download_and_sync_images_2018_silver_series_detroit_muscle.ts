...
const WIKI_URL = 'https://hotwheels.fandom.com/wiki/Detroit_Muscle_Series_(2018)';
const COLLECTION_NAME = 'Hot Wheels Silver Series';
const SERIES_NAME = 'Detroit Muscle (2018)';
const BASE_SUBDIR = 'silver-series/detroit-muscle';
...
async function main() {
  console.log('=== DETROIT MUSCLE (2018) IMAGE SCRIPT ===');
