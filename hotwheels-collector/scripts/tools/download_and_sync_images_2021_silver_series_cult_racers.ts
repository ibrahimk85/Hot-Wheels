/**
 * Download images for 2021 Cult Racers (Automotive) - 8-col table
 * npx ts-node scripts/tools/download_and_sync_images_2021_silver_series_cult_racers.ts
 */
...
const WIKI_URL = 'https://hotwheels.fandom.com/wiki/Cult_Racers_Series_(2021)';
const COLLECTION_NAME = 'Hot Wheels Silver Series';
const SERIES_NAME = 'Cult Racers (2021)';
const BASE_SUBDIR = 'silver-series/cult-racers';
...
async function main() {
  console.log('=== CULT RACERS (2021) IMAGE SCRIPT ===');
