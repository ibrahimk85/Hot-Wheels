/**
 * Download images for 2022 Luxury Sedans (Automotive)
 * npx ts-node scripts/tools/download_and_sync_images_2022_silver_series_luxury_sedans.ts
 */
...
const WIKI_URL = 'https://hotwheels.fandom.com/wiki/Luxury_Sedans_Series_(2022)';
const COLLECTION_NAME = 'Hot Wheels Silver Series';
const SERIES_NAME = 'Luxury Sedans (2022)';
const BASE_SUBDIR = 'silver-series/luxury-sedans';
...
async function main() {
  console.log('=== LUXURY SEDANS (2022) IMAGE SCRIPT ===');
