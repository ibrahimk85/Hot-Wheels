/**
 * Download images for 2024 HW Speed Graphics (Automotive) - 10-col table
 * npx ts-node scripts/tools/download_and_sync_images_2024_silver_series_speed_graphics.ts
 */
...
const WIKI_URL = 'https://hotwheels.fandom.com/wiki/HW_Speed_Graphics_Series_(2024)';
const COLLECTION_NAME = 'Hot Wheels Silver Series';
const SERIES_NAME = 'HW Speed Graphics (2024)';
const BASE_SUBDIR = 'silver-series/speed-graphics';
...
async function main() {
  console.log('=== HW SPEED GRAPHICS (2024) IMAGE SCRIPT ===');
