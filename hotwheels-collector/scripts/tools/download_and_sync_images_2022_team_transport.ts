/**
 * Script to download image assets for the 2022 Hot Wheels Team Transport set and
 * associate them with Model and Variant records in your database.
 *
 * This script performs two jobs:
 *   1. Fetches the 2022 Team Transport page from the Hot Wheels Fandom wiki and
 ...
 *      `public/images/hotwheels/2022/team-transport/` folder.
 ...
 *     the 2022 Team Transport variants using the import script.
 ...
 *
 * Usage:
 *   npx ts-node scripts/tools/download_and_sync_images_2022_team_transport.ts
 */
...
const TEAM_TRANSPORT_URL = 'https://hotwheels.fandom.com/wiki/2022_Car_Culture:_Team_Transport';
...
async function main() {
  ...
  for (let tableIdx = 0; tableIdx < tables.length; tableIdx++) {
    ...
    // Special handling for "Supreme Exclusive" or "Walmart Legends Tour Exclusive" - it might have a different table structure
    const isSupremeExclusive = subSeriesName.toLowerCase().includes('supreme') || subSeriesName.toLowerCase().includes('walmart');
