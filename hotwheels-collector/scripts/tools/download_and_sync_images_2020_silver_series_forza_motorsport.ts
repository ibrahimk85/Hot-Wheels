/**
 * Download images for 2020 Forza Motorsport (Automotive) - 8-col: Series # | Toy # | Casting | Color | Tampos | Wheel Type | Notes | Photo - Car | Photo - Card
 * npx ts-node scripts/tools/download_and_sync_images_2020_silver_series_forza_motorsport.ts
 */
...
const WIKI_URL = 'https://hotwheels.fandom.com/wiki/Forza_Motorsport_Series_(2020)';
const COLLECTION_NAME = 'Hot Wheels Silver Series';
const SERIES_NAME = 'Forza Motorsport (2020)';
const BASE_SUBDIR = 'silver-series/forza-motorsport';
...
async function main() {
  console.log('=== FORZA MOTORSPORT (2020) IMAGE SCRIPT ===');
