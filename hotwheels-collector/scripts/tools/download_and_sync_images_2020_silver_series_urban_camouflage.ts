/**
 * Download images for 2020 Urban Camouflage (Automotive) - 8-col: Col # | Toy # | Casting | Body Color | Wheel Type | Notes | Photo Loose | Photo Carded
 * npx ts-node scripts/tools/download_and_sync_images_2020_silver_series_urban_camouflage.ts
 */
...
const WIKI_URL = 'https://hotwheels.fandom.com/wiki/Urban_Camouflage_Series_(2020)';
const COLLECTION_NAME = 'Hot Wheels Silver Series';
const SERIES_NAME = 'Urban Camouflage (2020)';
const BASE_SUBDIR = 'silver-series/urban-camouflage';
...
async function main() {
  console.log('=== URBAN CAMOUFLAGE (2020) IMAGE SCRIPT ===');
