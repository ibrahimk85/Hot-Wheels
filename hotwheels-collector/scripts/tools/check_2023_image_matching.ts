...
async function check2023ImageMatching() {
  console.log('=== Checking 2023 Mainline Image Matching ===\n');

  // Get all 2023 Mainline variants
  ...
  console.log(`Total 2023 Mainline variants: ${variants.length}\n`);
