...
async function main() {
  console.log('Testing 2014 Mainline data and images...\n');
  ...
  if (!mainlineCollection) {
    console.error('2014 Mainline collection not found!');
    return;
  }

  // Get all variants for 2014 Mainline
  ...
  console.log(`Total 2014 Mainline variants: ${allVariants.length}\n`);
  ...
  console.log(`Toy# Status (CRITICAL for 2014):`);
