/**
 * Download images for 2022 Spider-Man (Entertainment) - 8-col
 * npx ts-node scripts/tools/download_and_sync_images_2022_silver_series_spiderman.ts
 */
...
const WIKI_URL = 'https://hotwheels.fandom.com/wiki/Spider-Man_Series_(2022)';
const COLLECTION_NAME = 'Hot Wheels Silver Series';
const SERIES_NAME = 'Spider-Man (2022)';
const BASE_SUBDIR = 'silver-series/spiderman';
...
async function main() {
  console.log('=== Spider-Man (2022) IMAGE SCRIPT ===');
