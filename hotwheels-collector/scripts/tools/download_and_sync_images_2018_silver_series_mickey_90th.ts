...
const WIKI_URL = 'https://hotwheels.fandom.com/wiki/Mickey_Mouse_90th_Anniversary_Series_(2018)';
const COLLECTION_NAME = 'Hot Wheels Silver Series';
const SERIES_NAME = 'Mickey Mouse 90th Anniversary (2018)';
const BASE_SUBDIR = 'silver-series/mickey-90th';
...
async function main() {
  console.log('=== Mickey Mouse 90th Anniversary (2018) IMAGE SCRIPT ===');
