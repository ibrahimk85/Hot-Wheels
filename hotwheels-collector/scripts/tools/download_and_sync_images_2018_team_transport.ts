/**
 * Script to download image assets for the 2018 Hot Wheels Team Transport set and
 * associate them with Model and Variant records in your database.
 *
 * This script performs two jobs:
 *   1. Fetches the 2018 Team Transport page from the Hot Wheels Fandom wiki and
 ...
 *      `public/images/hotwheels/2018/team-transport/` folder.
 ...
 *     the 2018 Team Transport variants using the import script.
