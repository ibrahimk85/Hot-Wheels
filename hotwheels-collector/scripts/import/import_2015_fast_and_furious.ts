/**
 * Script to import the 2015 Hot Wheels Fast & Furious Series set into your database using Prisma.
 *
 * This script:
 *   1. Fetches the Fast & Furious Series page from Hot Wheels Fandom wiki
 *   2. Parses the 2015 year table
 ...
 * - SubSeries: "2015" (single table, no sub-series)
 * - Model metadata from detail pages
 * - Photo - Card and Photo - Car columns - will be handled by image download script
 *
 ...
 *
 * How to use:
 *   npx ts-node scripts/import/import_2015_fast_and_furious.ts
 *
 * Notes:
 ...
 *   - Single table for year 2015 (no sub-series)
 */
