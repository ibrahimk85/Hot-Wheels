/**
 * Script to import the 2024 Hot Wheels Boulevard set into your database using Prisma.
 *
 * This script:
 *   1. Fetches the 2024 Boulevard page from Hot Wheels Fandom wiki
 *   2. Parses multiple tables (Mix 1, Mix 2, Mix 3, Mix 4, Mix 5, Rerelease Mix)
 ...
 *   5. Creates database records: Year → Collection (Boulevard) → SubSeries (Mix1-5 + Rerelease Mix) → Model → Variant
 *
 * Boulevard-specific:
 * - No TH/STH (always false)
 * - SubSeries are Mix 1, Mix 2, Mix 3, Mix 4, Mix 5, Rerelease Mix
 * - Model metadata from detail pages
 *
 * How to use:
 *   npx ts-node scripts/import/import_2024_boulevard.ts
 *
 * Notes:
...
const URL = 'https://hotwheels.fandom.com/wiki/2024_Hot_Wheels_Boulevard';
