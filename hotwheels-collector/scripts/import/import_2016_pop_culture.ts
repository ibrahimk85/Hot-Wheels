/**
 * Script to import the 2016 Hot Wheels Pop Culture set into your database using Prisma.
 *
 * This script:
 *   1. Fetches the 2016 Pop Culture page from Hot Wheels Fandom wiki
...
const URL = 'https://hotwheels.fandom.com/wiki/2016_Pop_Culture';
...
async function main() {
  ...
  for (let tableIdx = 0; tableIdx < tables.length; tableIdx++) {
    ...
    for (let i = 0; i < rows.length; i++) {
      ...
      // Extract data based on known column structure for 2016
