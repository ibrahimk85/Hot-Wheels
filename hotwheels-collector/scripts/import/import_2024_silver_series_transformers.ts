/**
 * Import 2025 Hot Wheels Silver Series - Transformers (Entertainment category)
 * Supports 8-col and 10-col tables
 * npx ts-node scripts/import/import_2024_silver_series_transformers.ts
 */
...
const URL = 'https://hotwheels.fandom.com/wiki/Transformers_Series_(2024)';
...
async function main() {
  console.log(`Fetching Transformers (${targetYear}) from ${URL}…`);
  const res = await fetch(URL, { headers: { 'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36' } });
