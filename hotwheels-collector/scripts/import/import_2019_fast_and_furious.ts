/**
 * Script to import the 2019 Hot Wheels Fast & Furious Series set into your database using Prisma.
 *
 * This script:
 *   1. Fetches the Fast & Furious Series page from Hot Wheels Fandom wiki
 *   2. Parses the 2019 year table
 ...
 *
 * How to use:
 *   npx ts-node scripts/import/import_2019_fast_and_furious.ts
 *
 * Notes:
 ...
 *   - Single table for year 2019 (no sub-series)
 */
