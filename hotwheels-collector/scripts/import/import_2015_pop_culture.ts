/**
 * Script to import the 2015 Hot Wheels Pop Culture set into your database using Prisma.
 *
 * This script:
 *   1. Fetches the 2015 Pop Culture page from Hot Wheels Fandom wiki
 *   2. Parses multiple tables (each sub-series has its own table)
 *   3. Extracts data: Series #, Toy #, Casting Name, Theme, Body Color, Wheel Type, Notes
 ...
 *   - Column structure may vary - adjust indices if needed based on actual table structure
 */
...
const URL = 'https://hotwheels.fandom.com/wiki/2015_Pop_Culture';
...
async function main() {
  ...
  for (let tableIdx = 0; tableIdx < tables.length; tableIdx++) {
    ...
    for (let i = 0; i < rows.length; i++) {
      ...
      // Extract data based on known column structure for 2015
      // NOTE: Column order may vary - verify against actual wiki page
      // Expected: Series #, Toy #, Casting Name, Theme, Body Color, Wheel Type, Notes
      ...
      // Include theme in the check for Pop Culture
