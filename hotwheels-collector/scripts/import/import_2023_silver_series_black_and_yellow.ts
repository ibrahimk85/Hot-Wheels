/**
 * Script to import the 2023 Hot Wheels Silver Series - Black and Yellow 55th Anniversary set into your database.
 *
 * This script:
 ...
 *
 * How to use:
 *   npx ts-node scripts/import/import_2023_silver_series_black_and_yellow.ts
 */
...
const URL = 'https://hotwheels.fandom.com/wiki/55th_Anniversary_Black_and_Yellow_Series_(2023)';
...
/**
 * Black and Yellow table: Col# | Toy# | Casting Name | Color | Tampo | Wheel Type | Notes | Photo Loose | Photo Carded
 */
...
async function main() {
  console.log(`Fetching Black and Yellow 55th Anniversary Series (${targetYear}) from ${URL}…`);
