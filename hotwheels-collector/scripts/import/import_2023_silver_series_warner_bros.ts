/**
 * Import 2025 Hot Wheels Silver Series - Warner Bros. 100th Anniversary (Entertainment category)
 * Supports 8-col and 10-col tables
 * npx ts-node scripts/import/import_2023_silver_series_warner_bros.ts
 */
...
const URL = 'https://hotwheels.fandom.com/wiki/Warner_Bros._100th_Anniversary_Series_(2023)';
...
async function main() {
  console.log(`Fetching Warner Bros. 100th Anniversary (${targetYear}) from ${URL}…`);
  const res = await fetch(URL, { headers: { 'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36' } });
