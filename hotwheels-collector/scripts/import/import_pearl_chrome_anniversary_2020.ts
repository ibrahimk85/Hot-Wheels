/**
 * Script to import the 2020 Pearl&Chrome Anniversary Series (Pearl and Chrome Series)
 * into your database using Prisma.
 *
 * How to use:
 *   npx ts-node scripts/import/import_pearl_chrome_anniversary_2020.ts
 */
...
const SUB_SERIES_NAME = 'Pearl and Chrome Series';
