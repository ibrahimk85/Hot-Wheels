/**
 * Script to import the 2025 Hot Wheels Team Transport set into your database using Prisma.
 *
 * This script:
 *   1. Fetches the 2025 Team Transport page from Hot Wheels Fandom wiki
 ...
 *
 * How to use:
 *   npx ts-node scripts/import/import_2025_team_transport.ts
 */
...
const URL = 'https://hotwheels.fandom.com/wiki/2025_Car_Culture:_Team_Transport';
...
function extractSubSeriesName($: cheerio.CheerioAPI, table: any): string {
  ...
  // Clean up sub-series name: remove trailing [] if present (2024/2025 format)
...
async function main() {
  ...
  for (let tableIdx = 0; tableIdx < tables.length; tableIdx++) {
    ...
    for (let i = 0; i < rows.length; i++) {
      ...
      // 2024/2025 format: Series# can be "#74" (with # prefix)
