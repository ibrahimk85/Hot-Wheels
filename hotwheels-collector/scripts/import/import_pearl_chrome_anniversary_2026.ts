/**
 * Script to import the 2026 Pearl&Chrome Anniversary Series (Blue and Gold Series)
 * into your database using Prisma.
 *
 * How to use:
 *   npx ts-node scripts/import/import_pearl_chrome_anniversary_2026.ts
 */
...
const SUB_SERIES_NAME = 'Blue and Gold Series';
