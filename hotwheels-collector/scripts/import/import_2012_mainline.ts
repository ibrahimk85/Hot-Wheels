/**
 * Script to import the 2012 Hot Wheels Mainline set into your database using Prisma.
 *
 * This script fetches ALL tables from the 2012 Hot Wheels Fandom wiki page.
 ...
 *
 * IMPORTANT: 2012'de 2nd color ve 3rd color varyantları aynı COL#'ye sahipken
 ...
 *
 *         npx ts-node import_2012_mainline.ts
 */
...
// URL of the Fandom page containing the 2012 mainline list
const URL = 'https://hotwheels.fandom.com/wiki/List_of_2012_Hot_Wheels';
...
async function main() {
  console.log('Fetching 2012 mainline data…');
  ...
  for (const tableInfo of tablesToProcess) {
    ...
    for (let i = 0; i < rows.length; i++) {
      ...
      const isNewFor2012 = /New for 2012/i.test(combinedText);
      ...
      if (isNewFor2012) notesParts.push('New for 2012');
