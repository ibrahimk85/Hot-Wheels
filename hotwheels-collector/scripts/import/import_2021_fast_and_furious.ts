/**
 * Script to import the 2021 Hot Wheels Fast & Furious Series set into your database using Prisma.
 *
 * This script:
 *   1. Fetches the Fast & Furious Series page from Hot Wheels Fandom wiki
 *   2. Parses the 2021 year table
 *   3. Extracts data: Col #, Casting Name, Color, Tampo, Wheel Type, Toy #, Notes
 ...
 * - SubSeries: "2021" (single table, no sub-series)
 ...
 *
 * How to use:
 *   npx ts-node scripts/import/import_2021_fast_and_furious.ts
 *
 * Notes:
 ...
 *   - Single table for year 2021 (no sub-series)
 */
