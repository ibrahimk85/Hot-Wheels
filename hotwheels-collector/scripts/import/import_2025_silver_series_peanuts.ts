/**
 * Import 2025 Hot Wheels Silver Series - Peanuts 75 Years (Entertainment category)
 * Supports 8-col and 10-col tables
 * npx ts-node scripts/import/import_2025_silver_series_peanuts.ts
 */
...
const URL = 'https://hotwheels.fandom.com/wiki/Peanuts_75_Years_Series_(2025)';
...
async function main() {
  console.log(`Fetching Peanuts 75 Years (${targetYear}) from ${URL}…`);
  const res = await fetch(URL, { headers: { 'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36' } });
