/**
 * Script to import the 2021 Hot Wheels Pop Culture set into your database using Prisma.
 *
 * This script:
 *   1. Fetches the 2021 Pop Culture page from Hot Wheels Fandom wiki
 ...
 *
 * How to use:
 *   npx ts-node scripts/import/import_2021_pop_culture.ts
 *
 * Notes:
...
const URL = 'https://hotwheels.fandom.com/wiki/2021_Pop_Culture';
