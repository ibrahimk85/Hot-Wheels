/**
 * Script to import the 2026 Hot Wheels Silver Series - Blue and Gold set into your database.
 *
 * This script:
 ...
 *
 * How to use:
 *   npx ts-node scripts/import/import_2026_silver_series_blue_and_gold.ts
 */
...
const URL = 'https://hotwheels.fandom.com/wiki/Blue_and_Gold_Series_(2026)';
...
/**
 * Blue and Gold table: Col# | Toy# | Casting Name | Color | Tampo | Wheel Type | Notes | Photo Loose | Photo Carded
 */
...
async function main() {
  console.log(`Fetching Blue and Gold Series (${targetYear}) from ${URL}…`);
