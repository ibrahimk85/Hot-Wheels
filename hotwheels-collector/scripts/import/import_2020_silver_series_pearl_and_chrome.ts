/**
 * Script to import the 2020 Hot Wheels Silver Series - Pearl and Chrome set into your database.
 *
 * Fetches from: https://hotwheels.fandom.com/wiki/Pearl_and_Chrome_Series_(2020)
 * Creates: Year → Collection (Hot Wheels Silver Series) → SubSeries (category=Anniversary) → Model → Variant
 *
 * How to use:
 *   npx ts-node scripts/import/import_2020_silver_series_pearl_and_chrome.ts
 */
...
const URL = 'https://hotwheels.fandom.com/wiki/Pearl_and_Chrome_Series_(2020)';
...
async function main() {
  console.log(`Fetching Pearl and Chrome Series (${targetYear}) from ${URL}…`);
