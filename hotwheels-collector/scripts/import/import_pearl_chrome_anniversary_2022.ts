/**
 * Script to import the 2022 Pearl&Chrome Anniversary Series (Blue and Pink Series)
 * into your database using Prisma.
 *
 * How to use:
 *   npx ts-node scripts/import/import_pearl_chrome_anniversary_2022.ts
 */
...
const SUB_SERIES_NAME = 'Blue and Pink Series';
