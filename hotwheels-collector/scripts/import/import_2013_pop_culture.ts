/**
 * Script to import the 2013 Hot Wheels Pop Culture set into your database using Prisma.
 *
 * This script:
 *   1. Fetches the 2013 Pop Culture page from Hot Wheels Fandom wiki
...
const URL = 'https://hotwheels.fandom.com/wiki/2013_Pop_Culture';
