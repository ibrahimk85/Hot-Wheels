/**
 * Script to import the 2024 Pearl&Chrome Anniversary Series (Green and Gold Series)
 * into your database using Prisma.
 *
 * How to use:
 *   npx ts-node scripts/import/import_pearl_chrome_anniversary_2024.ts
 */
...
const SUB_SERIES_NAME = 'Green and Gold Series';
