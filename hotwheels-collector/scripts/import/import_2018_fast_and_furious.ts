/**
 * Script to import the 2018 Hot Wheels Fast & Furious Series set into your database using Prisma.
 *
 * This script:
 *   1. Fetches the Fast & Furious Series page from Hot Wheels Fandom wiki
 *   2. Parses the 2018 year table
 ...
 *
 * How to use:
 *   npx ts-node scripts/import/import_2018_fast_and_furious.ts
 *
 * Notes:
 ...
 *   - Single table for year 2018 (no sub-series)
 */
...
async function main() {
  ...
  for (let i = 0; i < rows.length; i++) {
    ...
    // Parse series number from "1/6" format to just "1"
