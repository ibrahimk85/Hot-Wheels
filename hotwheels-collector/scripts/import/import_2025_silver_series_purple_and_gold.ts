/**
 * Script to import the 2025 Hot Wheels Silver Series - Purple and Gold set into your database.
 *
 * This script:
 ...
 *
 * How to use:
 *   npx ts-node scripts/import/import_2025_silver_series_purple_and_gold.ts
 */
...
/**
 * Purple and Gold table: Col# | Toy# | Casting Name | Color | Tampo | Wheel Type | Notes | Photo Loose | Photo Carded
 */
...
async function main() {
  console.log(`Fetching Purple and Gold Series (${targetYear}) from ${URL}…`);
