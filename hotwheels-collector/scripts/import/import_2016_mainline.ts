/**
 * Script to import the 2016 Hot Wheels Mainline set into your database using Prisma.
 *
 * This script fetches ALL tables from the 2016 Hot Wheels Fandom wiki page.
 ...
 *
 * IMPORTANT: 2016'da 2nd color ve 3rd color varyantları aynı COL#'ye sahipken
 ...
 *
 *         npx ts-node import_2016_mainline.ts
 */
...
// URL of the Fandom page containing the 2016 mainline list
const URL = 'https://hotwheels.fandom.com/wiki/List_of_2016_Hot_Wheels';
...
async function main() {
  console.log('Fetching 2016 mainline data…');
  ...
  for (const tableInfo of tablesToProcess) {
    ...
    for (let i = 0; i < rows.length; i++) {
      ...
      // Check both for TH/STH info (2016'da Series sütununda TH/STH bilgisi var)
      ...
      const isNewFor2016 = /New for 2016/i.test(combinedText);
      ...
      if (isNewFor2016) notesParts.push('New for 2016');
      ...
      // Check if variant already exists (by Toy# - CRITICAL for 2016)
