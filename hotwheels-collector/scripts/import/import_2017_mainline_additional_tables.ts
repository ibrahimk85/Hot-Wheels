/**
 * Script to import TH, STH, and additional tables after them from the 2017 Hot Wheels wiki.
...
async function main() {
  ...
  if (!mainlineCollection) {
    throw new Error('2017 Mainline collection not found. Please import mainline data first.');
  }
  ...
  // COL# counter starting from 366 (assuming 2017 also has 365 mainline models)
