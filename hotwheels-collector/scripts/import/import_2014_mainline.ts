/**
 * Script to import the 2014 Hot Wheels Mainline set into your database using Prisma.
 *
 * This script fetches ALL tables from the 2014 Hot Wheels Fandom wiki page.
 ...
 *
 * IMPORTANT: 2014'de 2nd color ve 3rd color varyantları aynı COL#'ye sahipken
 ...
 *
 *         npx ts-node import_2014_mainline.ts
 */
...
// URL of the Fandom page containing the 2014 mainline list
const URL = 'https://hotwheels.fandom.com/wiki/List_of_2014_Hot_Wheels';
...
async function main() {
  console.log('Fetching 2014 mainline data…');
  ...
  for (const tableInfo of tablesToProcess) {
    ...
    for (let i = 0; i < rows.length; i++) {
      ...
      const isNewFor2014 = /New for 2014/i.test(combinedText);
      ...
      if (isNewFor2014) notesParts.push('New for 2014');
