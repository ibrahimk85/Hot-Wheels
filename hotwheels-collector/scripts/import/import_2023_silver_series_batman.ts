/**
 * Import 2025 Hot Wheels Silver Series - Batman (Entertainment category)
 * Supports 8-col and 10-col tables
 * npx ts-node scripts/import/import_2023_silver_series_batman.ts
 */
...
const URL = 'https://hotwheels.fandom.com/wiki/Batman_Series_(2023_themed_assortment)';
...
async function main() {
  console.log(`Fetching Batman (${targetYear}) from ${URL}…`);
  const res = await fetch(URL, { headers: { 'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36' } });
