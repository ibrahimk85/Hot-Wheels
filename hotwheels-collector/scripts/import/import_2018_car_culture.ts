/**
 * Script to import the 2018 Hot Wheels Car Culture set into your database using Prisma.
 *
 * This script:
 *   1. Fetches the 2018 Car Culture page from Hot Wheels Fandom wiki
 ...
 *
 * How to use:
 *   npx ts-node scripts/import/import_2018_car_culture.ts
 *
 * Notes:
...
const URL = 'https://hotwheels.fandom.com/wiki/2018_Car_Culture';
...
async function main() {
  ...
  // Ensure the Collection record exists for "Car Culture"
  ...
  for (let tableIdx = 0; tableIdx < tables.length; tableIdx++) {
    ...
    for (let i = 0; i < rows.length; i++) {
      ...
      // Create Variant - Car Culture has NO TH/STH
