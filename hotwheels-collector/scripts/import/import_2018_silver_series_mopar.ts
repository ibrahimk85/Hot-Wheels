/**
 * Import 2018 Hot Wheels Silver Series - Mopar (Automotive category)
 * 8-col: Col # | Toy # | Casting | Color | Tampos | Wheel Type | Notes | Photo Loose | Photo Carded
 * npx ts-node scripts/import/import_2018_silver_series_mopar.ts
 */
...
const URL = 'https://hotwheels.fandom.com/wiki/Mopar_Series_(2018)';
