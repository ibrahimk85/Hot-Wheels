/**
 * Script to import the 2013 Hot Wheels Fast & Furious Series set into your database using Prisma.
 *
 * This script:
 *   1. Fetches the Fast & Furious Series page from Hot Wheels Fandom wiki
 *   2. Parses the 2013 year table
 ...
 * - SubSeries: "2013" (single table, no sub-series)
 ...
 *
 * How to use:
 *   npx ts-node scripts/import/import_2013_fast_and_furious.ts
 *
 * Notes:
 ...
 *   - Single table for year 2013 (no sub-series)
 */
