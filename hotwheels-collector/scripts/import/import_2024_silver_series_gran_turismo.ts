/**
 * Import 2025 Hot Wheels Silver Series - Gran Turismo (Entertainment category)
 * Supports 8-col and 10-col tables
 * npx ts-node scripts/import/import_2024_silver_series_gran_turismo.ts
 */
...
const URL = 'https://hotwheels.fandom.com/wiki/Gran_Turismo_Series_(2024)';
...
async function main() {
  console.log(`Fetching Gran Turismo (${targetYear}) from ${URL}…`);
  const res = await fetch(URL, { headers: { 'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36' } });
