/**
 * Import 2022 Hot Wheels Silver Series - Mud Runners (Automotive category)
 * npx ts-node scripts/import/import_2022_silver_series_mud_runners.ts
 */
...
const URL = 'https://hotwheels.fandom.com/wiki/Mud_Runners_Series_(2022)';
