/**
 * Script to import the 2011 Hot Wheels Mainline set into your database using Prisma.
 *
 * This script fetches ALL tables from the 2011 Hot Wheels Fandom wiki page.
 ...
 *
 * IMPORTANT: 2011'de 2nd color ve 3rd color varyantları aynı COL#'ye sahipken
 ...
 *
 *         npx ts-node import_2011_mainline.ts
 */
...
// URL of the Fandom page containing the 2011 mainline list
const URL = 'https://hotwheels.fandom.com/wiki/List_of_2011_Hot_Wheels';
...
async function main() {
  console.log('Fetching 2011 mainline data…');
  ...
  for (const tableInfo of tablesToProcess) {
    ...
    for (let i = 0; i < rows.length; i++) {
      ...
      const isNewFor2011 = /New for 2011/i.test(combinedText);
      ...
      if (isNewFor2011) notesParts.push('New for 2011');
