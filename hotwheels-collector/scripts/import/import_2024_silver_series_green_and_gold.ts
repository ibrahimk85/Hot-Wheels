/**
 * Script to import the 2024 Hot Wheels Silver Series - Green and Gold set into your database.
 *
 * This script:
 ...
 *
 * How to use:
 *   npx ts-node scripts/import/import_2024_silver_series_green_and_gold.ts
 */
...
const URL = 'https://hotwheels.fandom.com/wiki/Green_and_Gold_Series_(2024)';
...
/**
 * Green and Gold table: Col# | Toy# | Casting Name | Color | Tampo | Wheel Type | Notes | Photo Loose | Photo Carded
 */
...
async function main() {
  console.log(`Fetching Green and Gold Series (${targetYear}) from ${URL}…`);
