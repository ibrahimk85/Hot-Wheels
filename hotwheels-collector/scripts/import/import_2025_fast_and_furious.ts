/**
 * Script to import the 2025 Hot Wheels Fast & Furious Series set into your database using Prisma.
 *
 * This script:
 ...
 * - SubSeries: Brian O'Conner, Villains, Racing Course, Graphic Remix
 * - Model metadata from detail pages
 * - Photo Carded and Photo Loose columns - will be handled by image download script
 *
 * How to use:
 *   npx ts-node scripts/import/import_2025_fast_and_furious.ts
 *
 * Notes:
