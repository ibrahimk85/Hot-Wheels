/**
 * Script to import the 2020 Hot Wheels Fast & Furious Series set into your database using Prisma.
 *
 * This script:
 *   1. Fetches the Fast & Furious Series page from Hot Wheels Fandom wiki
 *   2. Parses the 2020 year table
 ...
 * - SubSeries: "2020" (single table, no sub-series)
 ...
 *
 * How to use:
 *   npx ts-node scripts/import/import_2020_fast_and_furious.ts
 *
 * Notes:
 ...
 *   - Single table for year 2020 (no sub-series)
 */
