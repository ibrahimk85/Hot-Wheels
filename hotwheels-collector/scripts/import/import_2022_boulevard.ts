/**
 * Script to import the 2022 Hot Wheels Boulevard set into your database using Prisma.
 *
 * This script:
 *   1. Fetches the 2022 Boulevard page from Hot Wheels Fandom wiki
 *   2. Parses multiple tables (Mix 1, Mix 2, Mix 3, Mix 4, Mix 5)
 ...
 * - SubSeries are Mix 1, Mix 2, Mix 3, Mix 4, Mix 5
 * - Model metadata from detail pages
 *
 * How to use:
 *   npx ts-node scripts/import/import_2022_boulevard.ts
 *
 * Notes:
...
const URL = 'https://hotwheels.fandom.com/wiki/2022_Hot_Wheels_Boulevard';
